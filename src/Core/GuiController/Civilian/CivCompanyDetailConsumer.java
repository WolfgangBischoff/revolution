...
public class CivCompanyDetailConsumer
{
    Company company;
    FXMLLoader loader;
    @FXML
    ...
    public CivCompanyDetailConsumer(Company company)
    {
        this.company = company;
        loader = new FXMLLoader(getClass().getResource("../../../fxml/civilian/civCompanyDetailConsumer.fxml"));
